...
StoryForge is an AI-powered story generator built with React on the frontend and Node.js/Express on the backend. It uses the Google Gemini API to generate creative stories based on your input — genre, tone, length, and custom tags.
...
```
storyforge/
├── StoryForge.jsx      # React frontend component
